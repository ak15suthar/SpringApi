...
public class MailerService {
	...
	public void sendOtpForEmailVerification(UserBean user) {
		String to = user.getEmail();// change accordingly

		// Sender's email ID needs to be mentioned
		String from = "portfolio.service.2020@gmail.com";// change accordingly
		final String username = "portfolio.service.2020@gmail.com";// change accordingly
		final String password = "Tejas@2020";// change accordingly
		...
		try {
			...
			message.setContent(
					"Hello " + user.getFirstName() + ", <b>" + user.getOtp()
	...
	public void sendOtpForForgetPassword(UserBean user) {
		String to = user.getEmail();// change accordingly
		...
		try {
			...
			// Now set the actual message
			message.setContent("Hello " + user.getFirstName() + ", <b>" + user.getOtp()
	...
	public void sendMailForPasswordUpdate(UserBean user) {
		...
		try {
			...
			// Now set the actual message
			message.setContent("Hello " + user.getFirstName() + ",   Your Password succssfully update.. <br>",
					"text/html");
